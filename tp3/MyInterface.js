...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.ambientIntensitySlider = 1.0;

        this.gui.add(this, 'ambientIntensitySlider', 0.1, 1.0).name('Ambient Intensity').onChange(this.updateAmbientIntensity.bind(this));
    ...
    updateAmbientIntensity() {
        this.scene.setAmbientIntensity(this.ambientIntensitySlider);
    }
